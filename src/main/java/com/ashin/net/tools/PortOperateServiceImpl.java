...
import com.ashin.net.utils.CmdUtils;
...
public class PortOperateServiceImpl implements PortOperateService {
    ...
    public List<PortInfo> listPort() {
        List<PortInfo> portInfos = parsePIDList(CmdConstants.LIST_PORT);
    ...
    public Integer kill(int pid) {
        List<String> list = CmdUtils.execute(CmdConstants.KILL_PROCESS + pid);
        return list.size();
    }

    private List<PortInfo> parsePIDList(String cmd) {
    ...
    public static void main(String[] args) {
        PortOperateServiceImpl portCheckService = new PortOperateServiceImpl();
