...
public class CmdUtils {
    ...
    public static List<String> execute(String cmd){
        ...
        try {
            ...
            BufferedReader out = new BufferedReader(new InputStreamReader(inputStream,  Charset.forName("UTF-8")));
            BufferedReader err = new BufferedReader(new InputStreamReader(new BufferedInputStream(errorStream),  Charset.forName("UTF-8")));
            String temp = null;
